...
let { PropertyUndefinedError, DataPathUndefinedError } = require('./errors');
    ...
    return function innerSort(a, b) {
        if (!a.hasOwnProperty(key) || !b.hasOwnProperty(key)) {
            ...
            if (!a.hasOwnProperty(key))
                throw new PropertyUndefinedError(key, a, null)
            // if (!b.hasOwnProperty(key))
            //     throw new PropertyUndefinedError(key, b, null)
        }
